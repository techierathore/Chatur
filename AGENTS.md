# Chatur — project session memory (all harnesses)
...
- **docs/Chatur-Coding-Standards.md** — strict compliance for every line of code you write or modify.
- **docs/Chatur-Architecture.md** — respect module boundaries.
...
Library issues go in the owning library's feedback file — docs/Chatur-TrBlazeUI-Feedback.md
or docs/Chatur-TechieRag-Feedback.md (one file per library; each goes to its own team) —
